...
<body class="text-white bg-dark">
  <%@ include file="fix/nav.jsp" %>
    ...
    <section class="text-white bg-dark clean-block clean-form dark">
        ...
        <p class="text-center mb-4" style="max-width: 760px;margin-left: auto;margin-right: auto;">Have a build question, delivery query, or support issue? Our TechnoMart team usually replies within one business day.</p>
        <div class="container d-lg-flex d-xxl-flex align-items-lg-center justify-content-xxl-center align-items-xxl-center w-75" style="margin-top: 0;">
            ...
            <div><img class="d-lg-flex align-items-lg-center" src="assets/img/gif/image_processing20210422-11473-j96faa.gif" style="width: 500px;"  alt=""/></div>
        </div>
    </section>
</main>
