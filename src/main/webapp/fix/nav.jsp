    <nav class="navbar navbar-dark navbar-expand-lg fixed-top clean-navbar">
        <div class="container-fluid"><a class="navbar-brand logo" href="index.jsp">TechnoMart </a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse text-white-50" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item" ><a class="btn btn-dark border-0" role="button" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;" href="shopping-cart.jsp"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart-dash"><path d="M6.5 7a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4z"></path><path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"></path></svg>
                    <span class="badge">
                    <% try{
                    ...
                    <li class="nav-item" style="padding: 0px; margin: 0px;"><a class="nav-link" href="registration.jsp">Sign Up</a></li>
          		<%}
