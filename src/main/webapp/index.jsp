...
<%@include file="fix/nav.jsp" %>
	...
	<main class="text-white bg-dark page landing-page">
                        ...
                        <div class="container d-flex flex-column justify-content-center h-100">
                            <div class="row">
                                <div class="col col-md-8 col-xl-6 offset-md-2" data-aos="fade-right" data-aos-duration="1200" style="z-index: 1;">
                                    <div>
                                        <h1 class="text-uppercase fw-bold">Build Smarter.<br><br>Build Your Way.<br><br></h1>
                                        <p class="text-light my-3">Configure your perfect PC with TechnoMart's 2026 custom build flow.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col col-md-8 col-xl-6 offset-md-2" style="z-index: 1;">
                                    <div style="max-width: 500px;">
                                        <h1 class="text-uppercase fw-bold">HIGH PERFORMANCE,<br><br>CUSTOM BUILDS &amp; GAMING PCS<br><br></h1>
                                        <p class="text-white my-3" style="padding-right: 45px;">From first setup to elite rigs, tune every part around your gameplay and workflow.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/TM/workstation.png" alt="Slide Image" style="/*z-index: -1;*/">
                        <div class="container d-flex flex-column justify-content-center h-100">
                            <div class="row">
                                <div class="col col-md-8 col-xl-6 offset-md-2" style="z-index: 1;">
                                    <div style="max-width: 500px;">
                                        <h1 class="text-uppercase fw-bold">READY. SET. LEVEL UP.</h1>
                                        <p class="text-white my-3" style="padding-right: 75px;">Need speed now? Explore ready-to-ship desktops assembled and QA tested by our team.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="clean-block features">
            <div class="container">
                <div data-aos="fade-up" data-aos-duration="900" class="block-heading">
                    <h2 class="fs-1 text-info">Why TechnoMart</h2>
                    <p class="text-white">A modern PC marketplace for gamers, creators, and professionals in 2026.</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-5 feature-box" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-gear icon">
                        ...
                        <h4 class="fs-4"><strong>Deep Customization</strong><br></h4>
                        <p class="text-white">Pick every component, tune the budget, and preview compatibility before checkout.</p>
                    </div>
                    <div class="col-md-5 feature-box" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="100"><i class="icon-rocket icon"></i>
                        ...
                        <p class="text-white">Start online, save configurations, and get a fully assembled setup delivered to your door.<br></p>
                    </div>
                    <div class="col-md-5 feature-box" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300"><i class="fas fa-tv icon"></i>
                        <h4 class="fs-4"><strong>Ready To Ship PCs</strong></h4>
                        <p class="text-white">Choose curated systems for gaming, creative work, streaming, and productivity.</p>
                    </div>
                    <div class="col-md-5 feature-box" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-sticky icon">
                        ...
                        <h4 class="fs-4"><strong>Modern Design Language</strong><br></h4>
                        <p class="text-white">Premium airflow-focused cases with clean cable routing and RGB profiles that match your style.<br></p>
                    </div>
                </div>
            </div>
        </section>
        <section class="clean-block about-us">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xxl-6" data-aos="fade-right"><img class="rounded img-fluid border" src="assets/img/TM/lian-li-gaming-bundle-1.jpg" alt=""></div>
                    <div class="col-md-12 col-xxl-6" data-aos="fade-left"><img class="rounded img-fluid border" src="assets/img/TM/lian-li-gaming-bundle-2.jpg" alt=""></div>
                </div>
            </div>
        </section>
    </main>
